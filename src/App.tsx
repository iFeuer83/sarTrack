...
const LogoBanner = ({ className }: { className?: string }) => (
  <div className={cn("w-full max-w-xl h-24 bg-white border border-zinc-200 rounded-2xl p-3 flex items-center justify-center", className)}>
      ...
      <div className="max-w-md w-full">
        <Card className="p-6 space-y-5">
          <div className="text-center space-y-2">
            <LogoBanner className="mx-auto max-w-md h-28" />
...
const PrintQrView = ({ missionId }: { missionId: string }) => {
  ...
  return (
    <div className="min-h-screen bg-white p-6 flex flex-col items-center justify-center gap-6">
      <div className="text-center space-y-2">
        <LogoBanner className="mx-auto max-w-2xl h-28" />
